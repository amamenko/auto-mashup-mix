...
const Privacy = () => {
  return (
    <div className="policy_main_container">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Auto Mashup.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Auto Mashup, accessible from{" "}
            <a
              href="https://automashup.ml"
              target="_blank"
              rel="noopener noreferrer"
            >
              https://automashup.ml
      ...
      <ul>
        <li>
          <p>By email: automaticmashup@gmail.com</p>
        </li>
      </ul>
    </div>
  );
