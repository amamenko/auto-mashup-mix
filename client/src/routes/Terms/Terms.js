...
const Terms = () => {
  return (
    <div className="policy_main_container">
      ...
      <p>Welcome to Auto Mashup!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Auto Mashup's Website, located at https://automashup.ml.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Auto Mashup if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing Auto Mashup, you agreed to
        use cookies in agreement with the Auto Mashup's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Auto Mashup and/or its licensors own the
        intellectual property rights for all material on Auto Mashup. All
        intellectual property rights are reserved. You may access this from Auto
        Mashup for your own personal use subjected to restrictions set in these
        terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Auto Mashup</li>
        <li>Sell, rent or sub-license material from Auto Mashup</li>
        <li>Reproduce, duplicate or copy material from Auto Mashup</li>
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. Auto
        Mashup does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of Auto Mashup,its agents and/or affiliates. Comments reflect the views
        and opinions of the person who post their views and opinions. To the
        extent permitted by applicable laws, Auto Mashup shall not be liable for
      ...
      <p>
        Auto Mashup reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Auto Mashup a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Auto Mashup; and (d) the link
      ...
      <p>
        ...
        e-mail to Auto Mashup. Please include your name, your organization name,
      ...
      <p>
        No use of Auto Mashup's logo or other artwork will be allowed for
